...
dnnError_t  init_conversion(dnnPrimitive_t *cv, real **ptr_out,
...
void SpatialConvolutionMM_compare(
          THTensor * mkldnn,
          THTensor * old,
          long long len,
	  int compareSource
...
static void SpatialConvolutionMM_MKLDNN_init_forward(
          THLongTensor *primitives,
          int N,
          int inC,
          int inH,
...
static void SpatialConvolutionMM_MKLDNN_init_bwddata(
          THLongTensor *primitives,
          int N,
          int inC,
          int inH,
...
static void SpatialConvolutionMM_MKLDNN_init_bwdfilter(
          THLongTensor *primitives,
          int N,
          int inC,
          int inH,
