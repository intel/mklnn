...
void MKLNN_RealBatchNormalization_updateOutput(
   ...
   THMKLRealTensor *save_mean, 
   THMKLRealTensor *save_std,
   bool train, 
   double momentum, 
   double eps,
   THLongTensor *primitives,
...
void MKLNN_RealBatchNormalization_backward(
  ...
  THMKLRealTensor *gradOutput, 
  THMKLRealTensor *gradInput,
  THMKLRealTensor *gradWeight, 
  THMKLRealTensor *gradBias, 
  THMKLRealTensor *weight,
  THMKLRealTensor *running_mean, 
  THMKLRealTensor *running_var,
  THMKLRealTensor *save_mean, 
  THMKLRealTensor *save_std,
  bool train, 
  double scale, 
